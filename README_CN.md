...
# DroidAssist ![license](http://img.shields.io/badge/license-Apache2.0-brightgreen.svg?style=flat) ![Release Version](https://img.shields.io/badge/release-1.0.4-blue.svg)
----------
...
```groovy
dependencies {
    classpath "com.didichuxing.tools:droidassist:1.0.4"
}
```
